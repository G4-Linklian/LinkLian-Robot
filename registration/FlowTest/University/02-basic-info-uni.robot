...
${USER_ID1}                       141227008
${USER_NAME}                      อภิชาติ
${USER_SURENAME}                  อิ่มยงค์
${USER_EMAIL}                     apichart.aim@example.com
${PHONE_NUMBER}                   0812345678
${SEMESTER}                       1/2570
${START_DATE}                     06/08/2570
${END_DATE}                       20/12/2570
...
Add Teacher With CSV
    ...
    Sleep    3s 
    ${FILE_TMP}    Set Variable    ${EXECDIR}/../Files/university/uni_academic_staff_template.xlsx
