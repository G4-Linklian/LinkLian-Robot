...
Add Section
    ...
    Sleep    2s
    Click Element    xpath=//*[@data-combobox-option="true" and contains(., "ว20104")]
...
Add Section With CSV
    ...
    Sleep    3s 
    ${FILE_TMP}    Set Variable    ${EXECDIR}/../Files/school/sch_section_template.xlsx
...
Manage Section
    Click Element    xpath=//table[@id="section-table"]//tr[td[1][normalize-space()='8']]
    ...
    Click Element    xpath=//*[@data-combobox-option="true" and contains(., "อาคารเรียนรวม")]
    Sleep    1s
    ...
    Input Text       //*[@id="select-teacher"]    141203   
    Click Element    xpath=//*[@data-combobox-option="true" and contains(., "141203")]
    ...
    Input Text       //*[@id="select-user"]    202600
    Click Element    xpath=//*[@data-combobox-option="true" and contains(., "202600")]
    Click Element    //*[@id="submit-button"]
    Sleep    5s
...
Add Enrollment With CSV
    ...
    Click Element    //*[@id="next-step-button"]
    Sleep    3s 
    ${FILE_TMP}    Set Variable    ${EXECDIR}/../Files/school/sch_enrollment_template.xlsx
    ${FILE}        Normalize Path    ${FILE_TMP}
    File Should Exist    ${FILE}
    Sleep    3s 
